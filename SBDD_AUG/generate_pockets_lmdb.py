...
def main():
    # fpocket_results directory
    fpocket_results_dir = "/home/tanhaichuan/GenPack_for_galaxy/fpocket_results"
    
    # Output LMDB file
    output_lmdb = os.path.join(fpocket_results_dir, "all_pockets.lmdb")
    
    # Step 1: Glob all pocket files first
    print("Searching for all pocket files...")
    all_pocket_files = glob.glob(os.path.join(fpocket_results_dir, "**/*pocket*.pdb"), recursive=True)
